  ...
  return (
    <div
      className={`w-full h-auto flex-wrap ${
        !next ? "items-start" : "justify-between"
      } ${!prev ? "items-end" : "justify-between"} flex items-center`}
    >
      {prev && (
        <div className="flex flex-col gap-2 ">
          ...
          <i className="max-w-[200px] text-zinc-700 dark:text-zinc-400 text-xl mt-2 font-medium font-lato">
      ...
      {next && (
        <div className="flex flex-col items-end gap-2 ">
          ...
          <i className="max-w-[200px] text-right text-zinc-700 dark:text-zinc-400 text-xl mt-2 font-medium font-lato">
            How to handle development ?{" "}
          </i>

    ...
    <div className="w-full h-auto flex items-center justify-center">
      <div className="w-full py-16 max-w-[1250px] px-10">
        <div className="flex flex-col gap-2 md:gap-4 justify-end items-end ">
          <h1 className="text-2xl md:text-5xl big-winks-text text-zinc-200 text-right">
            Have an Idea in mind <span className="font-hand">?</span>
          </h1>
          <p className="text-zinc-400 text-md md:text-lg text-right">
            I cant wait to make indcredible things with you !
          </p>

          <div className="bg-gradient-to-r from-[#2b2b2bd3] to-[#00000049] rounded-full w-[220px] h-[40px] flex items-center justify-between">
            <h1 className="px-4 text-lg font-manrope font-medium">Inquire</h1>
            <div
              data-name="circle"
              className="rounded-full w-[35px] h-[35px] bg-gradient-to-b flex items-center justify-center from-p1 via-p2 to-p3"
            >
        ...
        <div className="w-full relative">
          <div className="relative w-full h-[500px] md:h-[700px] flex items-center justify-center">
            ...
            <Image
              src="/spot1.png"
              alt="Spot-water-color"
              className="absolute top-0 left-0 -translate-y-16 -translate-x-16  opacity-5"
              width={1000}
              height={1000}
            />

            <p className="text-zinc-200 -rotate-6 big-winks-text text-center absolute text-2xl md:text-4xl max-w-4xl  tracking-widest ">
              {" "}
          ...
          <div className="w-full flex items-center justify-center z-[30]">
            <p className="text-zinc-300 text-sm md:text-md max-w-3xl text-center font-manrope mb-32">

...
const Hero = () => {
  return (
    <div className="py-32 px-4 backdrop-blur-md relative max-h-[1050px] sm:px-10 md:px-16 lg:px-32 w-full h-[94vh]  md:h-[100vh] flex flex-row justify-center ">
      <div className="flex scale-90 lg:scale-110 h-full flex-col md:flex-col md:dark:flex-row md:dark:gap-10 md:gap-0 items-center justify-center">
        <div className="flex  items-center justify-center">
          <div className="relative  flex items-center justify-center w-[250px] h-[250px] md:w-[350px] md:h-[350px]">
            {/* <Image
              ...
              alt="dashed-border-gradient-from-top-to-bottom hidden dark:block"
        ...
        <div className="mt-5 w-full relative">
          ...
          <div className="flex flex-col">
            ...
            <div className="w-full flex items-center gap-10 text-zinc-900 dark:text-zinc-200 flex-row mt-5">
              <div className="w-[50px] h-[1px] bg-zinc-800 dark:bg-zinc-200 border-none "></div>
              <p className="text-zinc-900 dark:text-zinc-200  h-full font-manrope text-sm md:text-md font-thin tracking-wider ">
                CHECK MY RESUME
              </p>
              <div className="flex items-center justify-center">
      ...
      <div className="absolute bottom-5 w-full h-[50px] flex items-center justify-center gap-10 ">
        <div className="text-zinc-900 dark:text-zinc-200  flex flex-row gap-10 items-center justify-center w-full">
          ...
          <Link href="https://github.com/Muhammad-Anique">
            <svg
          ...
          <Link href="https://www.instagram.com/anique.muhammad">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="20"
          ...
          <Link href="https://www.linkedin.com/in/anique-cs/">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="20"
